...
### [1. NumPy Fundamentals](/docs/pertemuan-3/numpy-fundamentals/)
- Apa itu NumPy
- Membuat dan manipulasi arrays
- Operasi matematika dan indexing

### [2. NumPy Advanced](/docs/pertemuan-3/numpy-advanced/)
- Reshape dan broadcasting
- Boolean indexing
- Operasi statistik

### [3. Pandas Series](/docs/pertemuan-3/pandas-series/)
- Apa itu Series
- Membuat dan mengakses Series
- Operasi pada Series

### [4. Pandas DataFrame Basics](/docs/pertemuan-3/pandas-dataframe-basics/)
- Membuat DataFrame
- Membaca file CSV
- Eksplorasi data awal

### [5. DataFrame Manipulation](/docs/pertemuan-3/dataframe-manipulation/)
- Mengakses data (loc, iloc)
- Filtering dan sorting
- Modifikasi kolom dan baris

### [6. Data Operations & Joining](/docs/pertemuan-3/data-operations/)
- Agregasi dan groupby
- Menggabungkan data (merge, concat)
- Menyimpan data

### [7. Project & Latihan](/docs/pertemuan-3/project-latihan/)
- Mini projects
- Challenge problems
- Best practices
