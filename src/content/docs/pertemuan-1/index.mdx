...
### [1. Definisi & Peran Data Science](/docs/pertemuan-1/definisi-peran/)
- Apa itu Data Science, AI, dan ML
- Peran dalam ekosistem data
- Karir di bidang data

### [2. Metodologi CRISP-DM](/docs/pertemuan-1/crisp-dm/)
- 6 fase CRISP-DM
- Penjelasan detail setiap fase
- Contoh implementasi

### [3. Tools & Teknologi](/docs/pertemuan-1/tools-teknologi/)
- Bahasa pemrograman yang digunakan
- Python libraries penting
- Environment dan tools development

### [4. Aplikasi & Skills](/docs/pertemuan-1/aplikasi-skills/)
- Contoh aplikasi Data Science
- Hard skills yang dibutuhkan
- Soft skills penting

### [5. FAQ](/docs/pertemuan-1/faq/)
