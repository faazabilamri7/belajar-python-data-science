...
### [1. Setup & Dasar Python](/pertemuan-2/setup-dasar/)
- Mengapa Python untuk Data Science
- Environment dan tools
- Menjalankan kode pertama

### [2. Tipe Data & Variabel](/pertemuan-2/tipe-data-variabel/)
- Variabel dan assignment
- Tipe data dasar (int, float, str, bool)
- Konversi tipe data
- String operations

### [3. Koleksi Data](/pertemuan-2/koleksi-data/)
- List (array)
- Dictionary (key-value)
- Tuple
- Operasi pada koleksi

### [4. Operator & Control Flow](/pertemuan-2/operator-control-flow/)
- Operator aritmatika, perbandingan, logika
- If-elif-else statements
- Loops (for, while)
- Break dan continue

### [5. Functions & Advanced](/pertemuan-2/functions-advanced/)
- Mendefinisikan functions
- Parameter dan return values
- Lambda functions
- List comprehension

### [6. Mini Project & Latihan](/pertemuan-2/mini-project/)
...
1. **[Langsung mulai pakai Python](/pertemuan-2/setup-dasar/)** - Setup environment
2. **[Pelajari tipe data](/pertemuan-2/tipe-data-variabel/)** - Foundation penting
3. **[Build project kecil](/pertemuan-2/mini-project/)** - Learning by doing
